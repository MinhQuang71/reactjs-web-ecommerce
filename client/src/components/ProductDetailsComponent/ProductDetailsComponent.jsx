...
const ProductDetailsComponent = () => {
  const onChange = () => { }
  return (
    <Row style={{ padding: "16px", backgronud: '#fff', borderRadius: '4px'}}>
        ...
        <Col span={14} style={{ paddingLeft: '10px'}} >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px'}}>
                <ButtonComponent
                    bordered={false}
                    size={40} 
                    styleButton={{background: 'rgb(255, 57, 69)', height: '48px', width: '270px', border: 'none', borderRadius: '4px' }} 
                    textButton={' Chon mua'}
                    styleTextButton={{ color: '#fff', fontSize: '15px', fontWeight: '700'}}>
                </ButtonComponent>
                <ButtonComponent
                    size={40} 
                    styleButton={{background: '#fff', height: '48px', width: '270px', border: '1px solid rgb(13, 92, 182)', borderRadius: '4px' }} 
